...
async function $f5bfd4ce37214f4f$var$loadTWSurvey(window, document) {
  try {
    ...
    const {
      ...
      test: testShopData,
      lg: language,
      ff: isFeatureFlagTrue,
      installType: type,
      disableAds: disableAds,
      adsAccountId: adsAccountId,
    } = await (0, $a17b80ad9d5e56ac$export$aab9f925224cbc2c)(state);

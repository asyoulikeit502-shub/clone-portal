...
.appikon-bis-form-warning{
  ...
  !(function(t, e) {
    ...
    (f.prototype.renderSection = function(t, n, i, r) {
      ...
      if (u) {
        if (m(u))
          for (var l = 0, c = u.length; l < c; ++l) a += this.renderTokens(t[4], n.push(u[l]), i, r);
        ...
        return (
          ...
          (n.prototype.render = function(t, e) {
            ...
            templateVars = SI.extend({}, e, SI.helpers, {
              ...
              is_default_variant: 1 === this.popover.variants.length &&
      ...
      SI.Promise = (function() {
        ...
        return (
          ...
          (e.prototype.execute = function() {
            for (var t;
              (t = this.callbacks.shift());) t.apply(t, this.data);
            return this;
          }),
          e
        );

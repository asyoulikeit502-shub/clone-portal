...
fbq.registerPlugin("999910245346986", {
  __fbEventsPlugin: 1,
  plugin: function(fbq, instance, config) {
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("999910245346986", "IWLBootstrapper", true);
    config.set("999910245346986", "cookie", {
      "fbcParamsConfig": {
        "params": [{
          "prefix": "",
          "query": "fbclid",
    ...
    instance.optIn("999910245346986", "FirstPartyCookies", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("999910245346986", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("999910245346986", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("999910245346986", "ProhibitedSources", true);
    config.set("999910245346986", "unwantedData", {
      "blacklisted_keys": {},
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("999910245346986", "UnwantedData", true);
    config.set("999910245346986", "IABPCMAEBridge", {
      "enableAutoEventId": true
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("999910245346986", "IABPCMAEBridge", true);
    config.set("999910245346986", "browserProperties", {
      "delayInMs": 200,
    ...
    instance.optIn("999910245346986", "BrowserProperties", true);
    config.set("999910245346986", "eventValidation", {
      "unverifiedEventNames": ["b14afe59f45fe72033d4713ccc2686473bcd35b6516c5a357eac04f1f2cefaed", "c60a4971541bd699edbcfbe85810ac6938e0d1c9908d24cf08527d3b780d239e"],
      "restrictedEventNames": ["AddPaymentInfo", "AddToCart", "CompleteRegistration", "InitiateCheckout", "Lead", "Purchase", "Subscribe"]
    });
    fbq.loadPlugin("eventvalidation");
    instance.optIn("999910245346986", "EventValidation", true);
    config.set("999910245346986", "protectedDataMode", {
      "standardParams": {
    ...
    instance.optIn("999910245346986", "ProtectedDataMode", true);
    config.set("999910245346986", "ccRuleEvaluator", {
      "ccRules": [],
      "wcaRules": [{
        "rule": {
          "and": [{
    ...
    instance.optIn("999910245346986", "CCRuleEvaluator", true);
    config.set("999910245346986", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("999910245346986", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("999910245346986", "LastExternalReferrer", true);
    fbq.loadPlugin("cookiedeprecationlabel");
    instance.optIn("999910245346986", "CookieDeprecationLabel", true);
    config.set("999910245346986", "unwantedParams", {
      "unwantedParams": ["delivery_category", "lead_event_source", "order_id", "user_bucket"]
    });
    fbq.loadPlugin("unwantedparams");
    instance.optIn("999910245346986", "UnwantedParams", true);
    config.set("999910245346986", "standardParamChecks", {
      "standardParamChecks": {
        "ad_type": [{
    ...
    instance.optIn("999910245346986", "StandardParamChecks", true);
    config.set("999910245346986", "gating", {
      "gatings": [{
    ...
    instance.optIn("999910245346986", "Gating", true);
    config.set("999910245346986", "botblocking", {
      "rules": {
    ...
    instance.optIn("999910245346986", "BotBlocking", true);
    fbq.loadPlugin("websiteperformance");
    instance.optIn("999910245346986", "WebsitePerformance", true);
    fbq.loadPlugin("urlparamschematization");
    instance.optIn("999910245346986", "URLParamSchematization", true);
    config.set("999910245346986", "browserPropertiesPlatform", {
      "enableIOS": true,
      "enableAndroid": true,
      "platformKeys": ["ime"],
    ...
    instance.optIn("999910245346986", "BrowserPropertiesPlatform", true);
    instance.configLoaded("999910245346986");
  }
});
...
class _pf_MediaGallery {
  ...
  touchStartHandler(e) {
    e.preventDefault(), 1 === e.touches.length && (this.pointState = {
      ...this.pointState,
      startX0: e.touches[0].pageX,
      startY0: e.touches[0].pageY
    }), 2 === e.touches.length && (this.pointState = {
      ...this.pointState,
      startX0: e.touches[0].pageX,
      startY0: e.touches[0].pageY,
...
function _pf_handleUpdateImageHeight(e, t) {
  var i, e = _pf_getFrontEndSettings(e)?.spacing || {
    ...
    a = _pf_getDevice();
  t.Components.Elements.getSlides().length && (i = t.options.perPage, e = parseInt(t.Components.Elements.getSlide(0).slide.style.width) - parseInt(e[a]) * (i - 1) / i, t.options = {
    ...t.options,
    fixedWidth: e,
    fixedHeight: e
  }, e) && t.emit("updated")

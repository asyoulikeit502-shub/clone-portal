...
fbq.registerPlugin("885026050204680", {
  __fbEventsPlugin: 1,
  plugin: function(fbq, instance, config) {
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("885026050204680", "IWLBootstrapper", true);
    config.set("885026050204680", "cookie", {
      "fbcParamsConfig": {
        "params": [{
          "prefix": "",
          "query": "fbclid",
    ...
    instance.optIn("885026050204680", "FirstPartyCookies", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("885026050204680", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("885026050204680", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("885026050204680", "ProhibitedSources", true);
    config.set("885026050204680", "unwantedData", {
      "blacklisted_keys": {},
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("885026050204680", "UnwantedData", true);
    config.set("885026050204680", "IABPCMAEBridge", {
      "enableAutoEventId": true
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("885026050204680", "IABPCMAEBridge", true);
    config.set("885026050204680", "browserProperties", {
      "delayInMs": 200,
    ...
    instance.optIn("885026050204680", "BrowserProperties", true);
    config.set("885026050204680", "eventValidation", {
      "unverifiedEventNames": ["6d127caf347cd01f9b17e3e3a64415bf77cfa6c20cb1e9915183d8931e92a520", "b14afe59f45fe72033d4713ccc2686473bcd35b6516c5a357eac04f1f2cefaed", "c60a4971541bd699edbcfbe85810ac6938e0d1c9908d24cf08527d3b780d239e"],
      "restrictedEventNames": ["AddPaymentInfo", "AddToCart", "CompleteRegistration", "InitiateCheckout", "Lead", "Purchase", "Subscribe"]
    });
    fbq.loadPlugin("eventvalidation");
    instance.optIn("885026050204680", "EventValidation", true);
    config.set("885026050204680", "protectedDataMode", {
      "standardParams": {
    ...
    instance.optIn("885026050204680", "ProtectedDataMode", true);
    config.set("885026050204680", "ccRuleEvaluator", {
      "ccRules": [],
      "wcaRules": [{
        "rule": {
          "or": [{
    ...
    instance.optIn("885026050204680", "CCRuleEvaluator", true);
    config.set("885026050204680", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("885026050204680", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("885026050204680", "LastExternalReferrer", true);
    fbq.loadPlugin("cookiedeprecationlabel");
    instance.optIn("885026050204680", "CookieDeprecationLabel", true);
    config.set("885026050204680", "unwantedParams", {
      "unwantedParams": ["delivery_category", "lead_event_source", "order_id", "user_bucket"]
    });
    fbq.loadPlugin("unwantedparams");
    instance.optIn("885026050204680", "UnwantedParams", true);
    config.set("885026050204680", "standardParamChecks", {
      "standardParamChecks": {
        "ad_type": [{
    ...
    instance.optIn("885026050204680", "StandardParamChecks", true);
    config.set("885026050204680", "gating", {
      "gatings": [{
    ...
    instance.optIn("885026050204680", "Gating", true);
    config.set("885026050204680", "botblocking", {
      "rules": {
    ...
    instance.optIn("885026050204680", "BotBlocking", true);
    fbq.loadPlugin("websiteperformance");
    instance.optIn("885026050204680", "WebsitePerformance", true);
    fbq.loadPlugin("urlparamschematization");
    instance.optIn("885026050204680", "URLParamSchematization", true);
    config.set("885026050204680", "browserPropertiesPlatform", {
      "enableIOS": true,
      "enableAndroid": true,
      "platformKeys": ["ime"],
    ...
    instance.optIn("885026050204680", "BrowserPropertiesPlatform", true);
    instance.configLoaded("885026050204680");
  }
});
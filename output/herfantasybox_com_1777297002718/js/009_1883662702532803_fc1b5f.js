...
fbq.registerPlugin("1883662702532803", {
  __fbEventsPlugin: 1,
  plugin: function(fbq, instance, config) {
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("1883662702532803", "IWLBootstrapper", true);
    config.set("1883662702532803", "cookie", {
      "fbcParamsConfig": {
        "params": [{
          "prefix": "",
          "query": "fbclid",
    ...
    instance.optIn("1883662702532803", "FirstPartyCookies", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("1883662702532803", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("1883662702532803", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("1883662702532803", "ProhibitedSources", true);
    config.set("1883662702532803", "unwantedData", {
      "blacklisted_keys": {},
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("1883662702532803", "UnwantedData", true);
    config.set("1883662702532803", "IABPCMAEBridge", {
      "enableAutoEventId": true
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("1883662702532803", "IABPCMAEBridge", true);
    config.set("1883662702532803", "browserProperties", {
      "delayInMs": 200,
    ...
    instance.optIn("1883662702532803", "BrowserProperties", true);
    config.set("1883662702532803", "eventValidation", {
    ...
    instance.optIn("1883662702532803", "EventValidation", true);
    config.set("1883662702532803", "protectedDataMode", {
      "standardParams": {
    ...
    instance.optIn("1883662702532803", "ProtectedDataMode", true);
    config.set("1883662702532803", "ccRuleEvaluator", {
      "ccRules": [],
      "wcaRules": [],
    ...
    instance.optIn("1883662702532803", "CCRuleEvaluator", true);
    config.set("1883662702532803", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("1883662702532803", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("1883662702532803", "LastExternalReferrer", true);
    fbq.loadPlugin("cookiedeprecationlabel");
    instance.optIn("1883662702532803", "CookieDeprecationLabel", true);
    config.set("1883662702532803", "unwantedParams", {
      "unwantedParams": ["delivery_category", "lead_event_source", "order_id", "user_bucket"]
    });
    fbq.loadPlugin("unwantedparams");
    instance.optIn("1883662702532803", "UnwantedParams", true);
    config.set("1883662702532803", "standardParamChecks", {
      "standardParamChecks": {
        "ad_type": [{
    ...
    instance.optIn("1883662702532803", "StandardParamChecks", true);
    config.set("1883662702532803", "gating", {
      "gatings": [{
    ...
    instance.optIn("1883662702532803", "Gating", true);
    config.set("1883662702532803", "botblocking", {
      "rules": {
    ...
    instance.optIn("1883662702532803", "BotBlocking", true);
    fbq.loadPlugin("websiteperformance");
    instance.optIn("1883662702532803", "WebsitePerformance", true);
    fbq.loadPlugin("urlparamschematization");
    instance.optIn("1883662702532803", "URLParamSchematization", true);
    config.set("1883662702532803", "browserPropertiesPlatform", {
      "enableIOS": true,
      "enableAndroid": true,
      "platformKeys": ["ime"],
    ...
    instance.optIn("1883662702532803", "BrowserPropertiesPlatform", true);
    instance.configLoaded("1883662702532803");
  }
});
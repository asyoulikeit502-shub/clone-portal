...
! function() {
  ...
  function s(e, t, o, i) {
    ...
    e += (e.match(/[\?]/g) ? "&" : "?") + "frame_id=" + t, "object" == typeof Shopify && Shopify.designMode && (e += e.includes("?") ? "&" : "?", e += "shopify_editor_preview=true"), LOOX.multilingual && LOOX.shopifyLocale && !e.includes("language=") && (e += "&language=" + LOOX.shopifyLocale), a.id = LOOX_OVERLAY_PREFIX + "_" + t, a.classList.add("loox-overlay"), i && i.postId && a.setAttribute("data-post-id", i.postId), i && i.productId && a.setAttribute("data-product-id", i.productId);
    ...
    i && (i.cssTextModification && (s += i.cssTextModification), i.overlay && (s += "background: " + (i.overlayColor || "rgba(238, 238, 238, 0.9)") + ";")), a.style.cssText = s;
    var l, d = i.marginTop || (600 < window.innerWidth ? "10%" : 0);
    if (a.innerHTML = '<div style="position:relative;min-height:' + (n ? "101%" : "100%") + ";" + (i.width ? "max-width:" + i.width : "max-width:900px") + ";margin: " + d + ' auto 0;"><div class="loox-iframe-focus-trap" style="position:absolute; width:1px; top:0; left:0; height:1px; z-index:1000; display:block;" tabindex="0" data-frame-id="' + t + '"></div>' + (s = e, n = "100%", d = i.title || "", '<iframe id="' + t + '" src="' + s + '" height="' + o + '" width="' + n + '" frameborder="0" scrolling="no" margin="0" style="overflow:hidden;height:' + o + ";width:1px;min-width:" + n + ";color-scheme:none;" + ((l = {
        "min-height": "600px",
        overflow: "auto"
      }) ? Object.keys(l).map(function(e) {
        return e + ": " + l[e]
      }).join(";") : "") + '" allowfullscreen="true" title="' + d + '"" allow="web-share; clipboard-read; clipboard-write"></iframe>') + '<div class="loox-iframe-focus-trap" style="position:absolute; bottom:0; right:0; width:1px; height:1px; z-index:1000; display:block;" tabindex="0" data-frame-id="' + t + '"></div></div>', i && i.close_btn && ((d = document.createElement("div")).id = "modalclose", d.style.cssText = "color:#424242; line-height:24px; position:absolute; right:20px; text-align:center; top:20px; width:24px; text-decoration:none; font-weight:bold; cursor:pointer; font-size:44px;", d.innerHTML = "&times;", a.children[0].appendChild(d), d.onclick = d = function(e) {
        if (e && e.stopPropagation(), history) try {
          return history.pushState("", document.title, window.location.pathname + window.location.search)
        } catch (e) {}
        y()
      }, a.onclick = d), !/iPhone\sOS\s14/.test(navigator.userAgent) && window.history && window.history.pushState) {
      try {
        history.pushState({
          url: e
        }, "", i.hash || "#qv")
  ...
  function i(e) {
    if ("https://loox.io" != f || "https://loox.io" == e.origin) {
      var t, o, i, r, a = e.data;
      if ("string" == typeof a && 0 === a.indexOf("{")) try {
        a = JSON.parse(a)
      } catch (e) {
        return
      }
      if ("resize" == a.type) {
        var n = document.getElementById(a.frame);
        if (n) {
          if ("visualViewport" === a.to) {
            var s = function() {
                if (window.top !== window) try {
                  const e = window.frameElement;
                  return e && "IFRAME" === e.tagName && e.hasAttribute("srcdoc")
                } catch {
                  return
                }
              }() ? window.parent : window,
              l = s.visualViewport ? s.visualViewport.height : s.innerHeight;
            return n.height = l, n.style.height = l + "px", n.parentNode.style.height = l + "px", n.style.minHeight = "", void(n.parentNode.style.minHeight = "")
          }
          w(a.frame, a.cssProps, a.applyAlsoToParentNode), v(a.frame, a.overlayColor);
          s = (a.height + "px").replace("vhpx", "vh").replace("%px", "%"), l = (a.minHeight + "px").replace("vhpx", "vh").replace("%px", "%");
          n.height = s, n.style.height = s, n.parentNode.style.height = s, l && (n.minHeight = l, n.style.minHeight = l, n.parentNode.style.minHeight = l)
        }
      }
      if ("consentCheck" === a.type) return LOOX.privacyUtils ? (LOOX.privacyUtils.isListening || LOOX.privacyUtils.listenToConsentApiChanges(), void(LOOX.report && LOOX.report.sendConsentUpdateToChild(e, a))) : void 0;
      if ("report" !== a.type)
        if ("reportPixel" !== a.type)
          if ("string" != typeof a.type || 0 !== a.type.indexOf("loox:")) {
            if ("reportShowOriginalClick" === a.type) {
              l = "show-original-clicked-ids", e = sessionStorage.getItem(l);
              const h = e ? JSON.parse(e) : [];
              if (!h.includes(a.postId) && LOOX.report && LOOX.report.sendPixel) {
                LOOX.report.sendPixel(a);
                const g = new Set(h);
                g.add(a.postId), sessionStorage.setItem(l, JSON.stringify([...g]))
              }
            }
            if ("reportQuickViewPixel" === a.type) {
              var d = "see-translated-posts-ids",
                c = sessionStorage.getItem(d);
              const O = c ? JSON.parse(c) : [];
              if (!O.includes(a.postId) && LOOX.report && LOOX.report.sendPixel) {
                LOOX.report.sendPixel(a);
                const m = new Set(O);
                m.add(a.postId), sessionStorage.setItem(d, JSON.stringify([...m]))
              }
            }
            if ("addToSessionStorage" !== a.type) {
              if ("scroll_to_view" != a.type || (t = document.getElementById("looxReviews")) && window.scrollTo(0, t.offsetTop), "closeModal" == a.type && ("srcdoc" !== window.location.pathname && (LOOX.ignorePopState = !0, history.back()), y(a.frame)), "write" == a.type && LOOX.showReviewForm(a.productId || LOOX.productId, a.language), "setSystem" == a.type && (LOOX.system = a.system), "quickview" === a.type && (c = a.postId, d = a.ref || null, t = a.language || null, o = a.thumbnails, i = a.showOriginal, r = a.markHighlight, LOOX.openQV(c, d, t, o, i, r)), "store-review-quickview" === a.type && ({
                  storeReviewId: o,
                  ref: i,
                  language: r,
                  showOriginal: p
                } = a, LOOX.openStoreQv(o, i, r, p)), "hc-floater" === a.type && LOOX.openHCFloater(a.productId), "set-ref-interaction" === a.type) {
                var p = sessionStorage;
                if (!p || null !== p.getItem("lxsrc")) return;
                p.setItem("lxsrc", JSON.stringify({
                  ref: a.ref
                }))
              }
              "setStyle" == a.type && (w(a.frame, a.cssProps, a.applyAlsoToParentNode), v(a.frame, a.overlayColor))
            } else sessionStorage.getItem(a.key) || (u = JSON.stringify(a.data), sessionStorage.setItem(a.key, u))
          } else {
            var u = a.payload && "object" == typeof a.payload ? a.payload : {};
            LOOX.publishAnalyticsEvent(a.type, u)
          }
      else LOOX.report && LOOX.report.sendPixel && LOOX.report.sendPixel(a);
      else LOOX.report && LOOX.report.sendGa && LOOX.report.sendGa(a.eventCategory, a.eventAction, a.eventLabel)
    }
  }
  __looxLoaded || ("undefined" != typeof LOOX ? (f = LOOX.root || "", __looxLoaded = !0, LOOX.hash = "undefined" != typeof loox_global_hash ? loox_global_hash : 1e3 * Math.floor((new Date).getTime() / 1e3 / 60 / 60) * 60 * 60, LOOX.isRTLDirection = function() {
    return "object" == typeof Shopify && "string" == typeof Shopify.locale && (Shopify.locale.includes("he") || Shopify.locale.includes("ar"))
  }, LOOX.shopifyLocale = "object" == typeof Shopify && Shopify.locale ? Shopify.locale : null, LOOX.publishAnalyticsEvent = function(e, t) {
    try {
      if (!window.Shopify || !window.Shopify.analytics || !window.Shopify.analytics.publish) return !1;
      var o = t && "object" == typeof t ? Object.assign({}, t) : {};
      return window.Shopify.analytics.publish(e, o), !0
    } catch (e) {
      return !1
    }
  }, LOOX.inject = s, LOOX.inject2 = function(e, t, o) {
    LOOX.lastActiveEl = document.activeElement;
    var i = (o || {}).overlayAttr || {},
      r = (o || {}).iframeAttr || {},
      o = (o || {}).hash;
    const a = document.createElement("div");
    a.id = LOOX_OVERLAY_PREFIX + "_" + t, a.classList.add("loox-overlay"), Object.assign(a.style, i.style || {}, {
      width: "100%",
      height: "100%",
      position: "fixed",
      top: "0",
    ...
    const n = new URL(e);
    n.searchParams.set("frame_id", t), LOOX.multilingual && LOOX.shopifyLocale && !n.searchParams.has("language") && n.searchParams.set("language", LOOX.shopifyLocale);
    let s = '<iframe id="{id}" src="{src}" allowfullscreen="allowfullscreen" title="{title}" allow="{allow}" style="{style}"></iframe>';
    const l = Object.assign(r.style || {}, {
        width: "100%",
        height: "100%",
        border: "0",
        padding: "0",
      ...
      d = {
        ...
        src: n.toString(),
        title: r.title || "",
        allow: (r.allow ? r.allow + ";" : "") + "fullscreen; web-share; clipboard-read; clipboard-write",
    ...
    let c = !1;
    const p = a.querySelector("#" + t);
    if (p && p.addEventListener("load", () => c = !0, {
        once: !0
      }), document.body.appendChild(a), o) try {
      history.pushState({
        url: n.toString()
      }, "", o)
    } catch (e) {
    ...
    window.document.body.classList.add("loox-overlay-is-active"), LOOX.activeFrame = a.id, setTimeout(function() {
      p && !c && (n.searchParams.set("retry", "1"), p.src = n.toString())
    }, 2e3)
  }, window.addEventListener("focus", e => {
    var t = e.target.classList && e.target.classList.contains("loox-iframe-focus-trap"),
      e = e.target.getAttribute && e.target.getAttribute("data-frame-id");
    const o = e ? document.getElementById(e) : null;
    t && e && o && o.focus()
  }, !0), LOOX.ignorePopState = !(y = function(e) {
    ...
    LOOX.ignorePopState || y(e), LOOX.ignorePopState = !1
  }), LOOX.closeModal = y, window.looxWrite = function(e) {
    i({
  ...
  }, LOOX.openQVWithHighlight = (...e) => {
    var [t, o, i, r, e] = e;
    LOOX.openQV(t, o, i, r, e, !0)
  }, LOOX.openQV = function(e, t, o, i, r, a) {
    var n = f + "/post/quickview/" + e;
    n += "?p=" + (LOOX.productId || ""), LOOX.system && (n += "&l=" + LOOX.system), LOOX.version && (n += "&ver=" + LOOX.version), LOOX.hash && (n += "&h=" + LOOX.hash);
    o = o || LOOX.shopifyLocale;
    LOOX.multilingual && o && (n += "&language=" + o), (t = t || LOOX.ref) && (n += "&ref=" + t), i && (n += "&thumbnails=" + i), r && (n += "&showoriginal=true"), a && (n += "&markhighlight=true"), s(n = "function" == typeof LOOX.withExperimentVariantParams ? LOOX.withExperimentVariantParams(n) : n, "quickview", "99vh", {
      width: "100%",
      hash: "#qv" + e,
      overlay: !0,
      ...
      postId: e,
      productId: LOOX.productId
    }), r = "qv", a = sessionStorage, n = e, a && (-1 < (e = (e = a.getItem(r)) ? e.split(",") : []).indexOf(n) || (e.push(n), a.setItem(r, e.join(","))))
  }, LOOX.openStoreQv = function(e, t, o, i) {
    const r = new URL("/post/store/quickview/" + e, f);
    LOOX.system && r.searchParams.set("l", LOOX.system), LOOX.version && r.searchParams.set("ver", LOOX.version), LOOX.hash && r.searchParams.set("h", LOOX.hash);
    o = o || LOOX.shopifyLocale;
    LOOX.multilingual && o && r.searchParams.set("language", o), (t = t || LOOX.ref) && r.searchParams.set("ref", t), i && r.searchParams.set("showoriginal", "true");
    i = r.toString();
    s(i = "function" == typeof LOOX.withExperimentVariantParams ? LOOX.withExperimentVariantParams(i) : i, "quickview", "99vh", {
      width: "100%",
      hash: "#srqv" + e,
      overlay: !0,
      marginTop: LOOX.fbScrollTop ? LOOX.fbScrollTop + "px" : "0",
      overlayColor: "rgba(0, 0, 0, 0.7)",
      title: "Store review quick view",
      productId: LOOX.productId
    })
    ...
    t && 0 < t.length && (o = f + "/widget/" + LOOX.clientId + "/dialog/" + t[1], LOOX.system && (o += "?l=" + LOOX.system), s(o, "looxDialog", "600px", {
      overlay: !0
    }));
    var o = /^\?lx_ep=([0-9A-Za-z_\-|.]+)/gi.exec(e);
    o && 0 < o.length && s(f + "/widget/" + LOOX.clientId + "/add-photo/" + o[1], "looxEdit", "600px", {
      overlay: !0
    });
    ...
    e && e.addEventListener("click", function(e) {
      ...
      }), LOOX.publishAnalyticsEvent("loox:widget_clicked", {
    ...
    return e
  }, ajax.send = function(e, t, o, i, r) {
    void 0 === r && (r = !0);
    var a = ajax.x();
    a.open(o, e, r), a.onreadystatechange = function() {
      if (4 == a.readyState) try {
        return t(JSON.parse(a.responseText))
      } catch (e) {
        return t(a.responseText)
      }
    }, "POST" == o && a.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), a.send(i)
  }, ajax.get = function(e, t, o, i) {
    var r, a = [];
    for (r in t) a.push(encodeURIComponent(r) + "=" + encodeURIComponent(t[r]));
    ajax.send(e + (a.length ? "?" + a.join("&") : ""), o, "GET", null, i)
  }, ajax.post = function(e, t, o, i) {
    var r, a = [];
    for (r in t) a.push(encodeURIComponent(r) + "=" + encodeURIComponent(t[r]));
    ajax.send(e, o, "POST", a.join("&"), i)
  },
  function() {
    var e, a = LOOX.root || "";
    LOOX.widgetRunOnce || (LOOX.widgetRunOnce = !0, LOOX.injectStyleTag('#looxReviews, #looxCarousel {float:none;clear:both;}#looxReviews:before, #looxReviews:after, #looxCarousel:before, #looxCarousel:after {content:" ";visibility:hidden;display:block;height:0;clear:both;}'), (e = function() {
      ...
      if (e && !e.getAttribute("data-upgraded")) {
        ...
        if (t && /columns/gi.test(t.className) && ((i = document.createElement("div")).className = "clearfix", e.parentNode.insertBefore(i, e)), LOOX.productId = e.getAttribute("data-product-id"), "{{product.id}}" == LOOX.productId) return console.error('LOOX reviews - product id is set to "{{ product.id }}" which is not a real product Id, the loox widget cannot be injected using settings or be placed inside a {% raw %} directive');
        var o = a + "/widget/" + LOOX.clientId + "/reviews",
          t = [];
        null != e.getAttribute("data-loox-aggregate") && LOOX.productId ? t.push("productId=" + LOOX.productId) : LOOX.productId && (o += "/" + LOOX.productId), LOOX.hash && t.push("h=" + LOOX.hash), LOOX.system && t.push("l=" + LOOX.system), LOOX.version && t.push("ver=" + LOOX.version);
        var i = e.getAttribute("data-mode");
        i && t.push("mode=" + i);
        i = e.getAttribute("data-or-productIds");
        i && t.push("productIds=" + i);
        i = e.getAttribute("data-tags");
        i && "" !== i && t.push("tags=" + encodeURIComponent(i));
        i = e.getAttribute("data-limit");
        i && t.push("limit=" + i);
        i = e.getAttribute("data-limit-mobile");
        i && window.innerWidth < 720 && t.push("limit=" + i);
        i = e.getAttribute("data-paging");
        i && t.push("paging=" + i);
        i = e.getAttribute("data-header");
        i && t.push("header=" + i);
        i = e.getAttribute("data-write-btn");
        i && t.push("write_btn=" + i);
        i = e.getAttribute("data-visibility");
        i && t.push("visibility=" + i);
        i = e.getAttribute("data-product-thumbnails");
        i && t.push("thumbnails=" + i);
        i = e.getAttribute("data-view");
        i && t.push("view=" + encodeURIComponent(i));
        i = e.getAttribute("data-disable-filter-review-rating");
        i && t.push("disable_filter_review_rating=" + i);
        i = e.getAttribute("data-reviews-to-display");
        i && t.push("reviews_to_display=" + i);
        i = e.getAttribute("data-default-tab");
        i && t.push("default_tab=" + i);
        i = e.getAttribute("data-variant");
        i && t.push("variant=" + i);
        i = e.getAttribute("data-language") || LOOX.shopifyLocale;
        LOOX.multilingual && i && t.push("language=" + encodeURIComponent(i));
        var i = e.getAttribute("data-loox-variant");
        i && t.push("widget_variant=" + i), "object" == typeof Shopify && Shopify.designMode && (t.push("shopify_editor_preview=true"), Shopify.theme && t.push("theme=" + Shopify.theme.id)), "true" === e.getAttribute("data-is_sample") && t.push("sample=true");
        const r = new URLSearchParams(window.location.search);
        r.has("loox_smart_sorting") && "true" === r.get("loox_smart_sorting") && (t.push("sort=score"), -1 !== (i = t.findIndex(e => e.startsWith("h="))) && (t[i] = "h=" + Date.now())), 0 < t.length && (o += "?" + t.join("&")), "function" == typeof LOOX.withExperimentVariantParams && (o = LOOX.withExperimentVariantParams(o));
        e.style.cssText || (e.style.margin = "0 auto;");
        e.innerHTML = '<iframe id="looxReviewsFrame" title="Reviews widget" src="' + o + '" height="0" width="100%" frameborder="0" scrolling="no" margin="0" style="overflow:hidden;height:0;width:100%; box-shadow:unset; outline:unset; color-scheme:none;"></iframe>'
      }
    })(), setInterval(e, 1e3))
  }(),
  function(r) {
    r && !r.pop_widget && "undefined" != typeof loox_pop_active && (r.pop_widget = {
      active: loox_pop_active,
      display_filter: "undefined" != typeof loox_pop_display ? loox_pop_display : null
    }, !r.pop_widget.active || function() {
      if (!r.pop_widget.display_filter) return 1;
      var e = window.location.pathname;
      return "/" === e ? r.pop_widget.display_filter.home_page : 0 === e.indexOf("/cart") ? r.pop_widget.display_filter.cart_page : r.productId ? r.pop_widget.display_filter.product_page : r.pop_widget.display_filter.other_pages
    }() && function(o) {
      var i = [];
      if (0 !== window.location.pathname.indexOf("/cart") || !r.ajax) return r.productId && i.push(r.productId), o(i);
      r.ajax.get("//" + window.location.hostname + "/cart.json", {}, function(e) {
        if (e && e.items)
          for (var t = 0; t < e.items.length; t++) i.push(e.items[t].product_id);
        return o(i)
      })
    }(function(e) {
      var t = r.root + "/widget/" + r.clientId + "/pop-notification.js",
        o = [];
      o.push("h=" + r.hash), 0 < e.length && (o.push("productIds=" + e.join(",")), r.pop_widget.hide_product = !0), "object" == typeof Shopify && Shopify.designMode && o.push("shopify_editor_preview=true"), 0 < o.length && (t += "?" + o.join("&"));
    ...
    var t, o;
    LOOX.root && LOOX.clientId && (t = [], e && (t.push("productIds=" + e), t.push("thumbnails=false")), t.push("h=" + LOOX.hash), "object" == typeof Shopify && Shopify.designMode && t.push("shopify_editor_preview=true"), (e = document.getElementById("looxReviews")) && ((o = e.getAttribute("data-reviews-to-display")) && t.push("reviews_to_display=" + o), (o = e.getAttribute("data-default-tab")) && t.push("default_tab=" + o)), o = LOOX.root + "/widget/" + LOOX.clientId + "/reviews", 0 < t.length && (o += "?" + t.join("&")), "function" == typeof LOOX.withExperimentVariantParams && (o = LOOX.withExperimentVariantParams(o)), LOOX.inject(o, "looxModalFrame", "100%", {
      width: "100%",
      overlay: !0,
      marginTop: "0px",
  ...
  function(n) {
    function e() {
      var e, t, o, i, r, a = document.getElementById("looxCarousel");
      a && 0 != a.length && !a.getAttribute("data-caraousel-loaded") && (a.setAttribute("data-caraousel-loaded", "true"), e = (n.root || "") + "/widget/" + n.clientId + "/carousel", (r = []).push("frame_id=" + (t = "looxCarouselFrame")), r.push("h=" + n.hash), i = a.getAttribute("data-language") || n.shopifyLocale, n.multilingual && i && r.push("language=" + encodeURIComponent(i)), null != (o = a.getAttribute("data-show-more") || null) && r.push("show_more_btn=" + encodeURIComponent(o)), null != (o = a.getAttribute("data-max-width") || null) && r.push("max_width=" + encodeURIComponent(o)), null != (o = a.getAttribute("data-arrows-color") || null) && r.push("arrows_color=" + encodeURIComponent(o)), null != (o = a.getAttribute("data-dots-color") || null) && r.push("dots_color=" + encodeURIComponent(o)), null != (o = a.getAttribute("data-button-color") || null) && r.push("button_color=" + encodeURIComponent(o)), null != (o = a.getAttribute("data-text-color") || null) && r.push("text_color=" + encodeURIComponent(o)), null != (o = a.getAttribute("data-background-color") || null) && r.push("background_color=" + encodeURIComponent(o)), null != (o = a.getAttribute("data-product-ids") || null) && r.push("productIds=" + encodeURIComponent(o)), null != (o = a.getAttribute("data-mode") || null) && r.push("mode=" + encodeURIComponent(o)), null != (o = a.getAttribute("data-use-widget-font") || null) && r.push("use_widget_font=" + encodeURIComponent(o)), i = a.getAttribute("data-language") || null, n.multilingual && null != i && r.push("language=" + encodeURIComponent(i)), "object" == typeof Shopify && Shopify.designMode && r.push("shopify_editor_preview=true"), 0 < r.length && (e += "?" + r.join("&")), (r = document.createElement("iframe")).id = t, r.src = e, r.height = "0", r.width = "100%", r.scrolling = "no", r.setAttribute("style", "display:block;border:0;overflow:hidden;height:0;width:100%;"), r.setAttribute("title", "Carousel reviews widget"), a.appendChild(r))
    }
    e(), setInterval(e, 1e3)
  }(LOOX || {});
var __loox_once = __loox_once || !1;
__loox_once || (__loox_once = !0, LOOX.domReady(function() {
    if ((a = window.location.search) && -1 !== a.indexOf("ref=loox")) {
      var e = sessionStorage;
      if (e && null === e.getItem("lxsrc")) {
        for (var t, o, i, r, a = a.substring(1).split("&"), n = {}, s = 0; s < a.length; s++) {
          var l, d = a[s].split("=");
          "ref" === d[0] && (n.ref = d[1]), "ref_source" === d[0] && (n.source = d[1]), "post_id" === d[0] && (n.post_id = d[1]), "lx_ad" === d[0] && (l = "LX" + d[1].toUpperCase(), t = "discount_code", o = l, r = i = void 0, d = "", i && ((r = new Date).setTime(r.getTime() + 24 * i * 60 * 60 * 1e3), d = "; expires=" + r.toUTCString()), document.cookie = t + "=" + (o || "") + d + "; path=/", n.code = l)
        }
        e.setItem("lxsrc", JSON.stringify(n))
      }
    }
  }), LOOX.domReady(function() {
    var e, t, o, i, r, a = sessionStorage;
    a && (t = a.getItem("lxsrc"), e = a.getItem("qv"), o = a.getItem("srpd"), (e || t || o) && (t = t && JSON.parse(t) || {}, o = o && JSON.parse(o) || {}, 0 !== window.location.pathname.indexOf("/cart") ? "object" == typeof Shopify && Shopify.checkout && Shopify.Checkout && ("thank_you" !== Shopify.Checkout.page && "checkout_one_thank_you" !== Shopify.Checkout.page || (i = ["c=" + LOOX.clientId, "o=" + Shopify.checkout.order_id, "t=" + Shopify.checkout.token], e && 0 < e.length && i.push("qv=" + e), t.ref && i.push("ref=" + t.ref), t.source && i.push("ref_source=" + t.source), t.post_id && i.push("post_id=" + t.post_id), !0 === o.active && i.push("ref=" + o.cat, "ref_source=" + o.l), a.removeItem("qv"), a.removeItem("lxsrc"), a.removeItem("srpd"), (r = document.createElement("img")).src = ["//pixel.loox.io", "track", "order"].join("/") + "?" + i.join("&"), r.setAttribute("style", "display:none;border:0;overflow:hidden;height:1px;width:1px;"), document.body.appendChild(r))) : (r = document.querySelector("form[action='/cart']")) && t.code && r.setAttribute("action", "/cart?discount=" + t.code)))
  }), LOOX.domReady(function() {
    var t, e;
    ...
    [].forEach.call(t, function(o) {
      var e, t, i, r, a, n = s + "?";
      o && (o.dataset.widgetLoaded = "true", (e = o.getAttribute("id")) ? (o.style.width = "100%", t = (a = function(e, t) {
        return o.getAttribute("data-" + e) || t
      })("preview", "no"), i = (i = o.querySelector("iframe")) || document.createElement("iframe"), r = {
        slideType: a("slide-type"),
        maxWidth: a("max-width"),
        borderRadius: a("border-radius"),
        itemsPerView: a("items-per-view"),
        mobileItemsPerView: a("mobile-items-per-view"),
        imageRatio: a("image-ratio"),
        maxNumberOfCharacters: a("max-number-of-characters"),
        desktopFontSize: a("desktop-font-size"),
        mobileFontSize: a("mobile-font-size"),
        reviewerNameColor: a("reviewer-name-color"),
        textColor: a("text-color"),
        itemBackgroundColor: a("item-background-color"),
        starsColor: a("stars-color"),
        starsBackgroundColor: a("stars-background-color"),
        arrows: {
          backgroundColor: a("arrows_background-color"),
          iconColor: a("arrows_icon-color"),
          hideOnMobile: a("arrows_hide-on-mobile", "yes")
        },
        shadow: a("shadow"),
        border: {
          active: a("border_active", "no"),
          width: a("border_width"),
          color: a("border_color")
        },
        pagination: {
          active: a("pagination_active", "no"),
          dotColor: a("pagination_dot-color"),
          selectedDotColor: a("pagination_selected-dot-color")
        },
        autoplay: {
          active: a("autoplay_active", "no"),
          duration: a("autoplay_duration")
        },
        quoteMarkIcon: a("quote-mark-icon"),
        quotesIconColor: a("quotes-icon-color"),
        productIds: a("product-ids"),
        frameId: e,
        h: LOOX.hash,
        theme: "undefined" != typeof Shopify && Shopify.theme ? Shopify.theme.id : void 0,
        preview: t,
        customerLocale: a("customer-locale")
      }, a = {
      ...
      }), n = n.slice(0, -1), i.dataset.lastChange !== JSON.stringify(r) && (i.src = n, i.width = "100%", i.height = "100%", i.id = e + "_FRAME", i.dataset.lastChange = JSON.stringify(r), i.setAttribute("style", "display:block;border:0;overflow:hidden;height:100%;width:100%;"), i.setAttribute("title", a[r.slideType] || a.gallery), o.appendChild(i))) : console.log("Loox V2 Carousel- missing container ID"))
    })
...
! function(n) {
  function e(n = !0) {
    const i = window.Shopify?.customerPrivacy;
    return i?.userCanBeTracked?.() ?? !!n
  }
  n && !n.privacyUtils && (n.privacyUtils = {
    canTrackUser: e,
    listenToConsentApiChanges: function(o) {
      !0 !== n.privacyUtils.isListening && (["trackingConsentLoaded", "trackingConsentAccepted", "trackingConsentDeclined", "trackingConsentReset"].forEach(i => {
...
! function() {
  ...
  function c(e, i, n, t) {
    if ("single-icon" !== t)
      for (let t = 1; t <= 5; t++) e.appendChild(function(t, e, i) {
        e = function(t, e) {
          return t <= e ? "full" : t <= e + .5 ? "half" : "empty"
        }(t, e);
        return a(e, i)
      }(t, i, n));
    else e.appendChild(a("full", n))
  }

  function a(t, e) {
    const i = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    i.classList.add("loox-icon"), i.setAttribute("viewBox", "0 0 24 24"), i.setAttribute("data-lx-fill", t), e && (i.style.color = e);
    const n = document.createElementNS("http://www.w3.org/2000/svg", "use");
    return n.setAttribute("href", "#looxicons-rating-icon"), i.appendChild(n), i
  }

  function d(t, e, i, n) {
    var r = u(t),
      a = Number(t.getAttribute("data-raters")) || 0;
    (a && !isNaN(a) || r) && (r = (t.getAttribute("data-pattern") || "").replace(/(<([^>]+)>)/gi, ""), i = i, n = n, r = r, a = (a = a).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","), i = i.toFixed(1), i = {
      labelContent: r ? r.replace(/\[count\]/gi, a).replace(/\[rating\]/gi, i) : "single-icon" === n ? i : `(${a})`,
      title: i + ` rating (${a} votes)`
    }, a = t.getAttribute("data-color-text"), e.innerHTML += `<span class="loox-rating-label" ${a?`style="color: ${a};"`:""} aria-hidden="true">&nbsp;${i.labelContent}</span>`, t.setAttribute("title", i.title), t.setAttribute("aria-label", i.title), t.setAttribute("role", "figure"), function(t, e) {
      const [i, ...n] = Array.from(t.querySelectorAll("svg")), r = document.createElementNS("http://www.w3.org/2000/svg", "title");
      r.textContent = e, i.prepend(r), i.setAttribute("role", "presentation"), n.forEach(t => t.setAttribute("aria-hidden", "true"))
    }(e, i.title))
  }
  ...
  function n(t, e) {
    if (l && e.classList.add("rtl"), !e.getAttribute("data-rating-upgraded")) {
      ...
      })(e) && (e.setAttribute("data-rating", "5"), e.setAttribute("data-raters", "1234")), (r = (n = e).getAttribute("data-content-size")) && n && (n.style.fontSize = r + "px");
      const a = e.getAttribute("data-id");
      s[a] && (e.setAttribute("data-rating", s[a].rating), e.setAttribute("data-raters", s[a].raters));
      var i = Number(e.getAttribute("data-rating")),
        n = u(e);
      if ((0 === i || isNaN(i)) && !n) a && null != e.getAttribute("data-fetch") && (t[a] || (t[a] = []), t[a].push(e), e.removeAttribute("data-fetch"));
      else {
        var r = Math.ceil(2 * i) / 2;
        const o = document.createElement("div");
        o.classList.add("loox-rating-content"), e.appendChild(o);
        n = e.getAttribute("data-color-star"), t = (t = (t = e).getAttribute("data-layout"), g.includes(t) ? t : "default");
        c(o, r, n, t), d(e, o, i, t);
        t = "yes" === e.getAttribute("data-preview");
        "true" === e.getAttribute("data-is-trust-badge") || function(e) {
          if (LOOX && LOOX.root && LOOX.clientId && LOOX.hash) {
            let t = `${LOOX.root}/widget/${LOOX.clientId}/rating?h=` + LOOX.hash;
            e && (t += "&preview=true"), fetch(t)
          }
        }(t), e.setAttribute("data-rating-upgraded", "1"), e.addEventListener("click", function() {
          LOOX && "function" == typeof LOOX.publishAnalyticsEvent && LOOX.publishAnalyticsEvent("loox:widget_clicked", {
            widgetType: "star-rating",
            productId: a
          })
        }), "true" === e.getAttribute("data-floating-product-reviews-enabled") && e.addEventListener("click", () => {
        ...
        if (Array.isArray(e.ratings) && !(e.ratings.length <= 0))
          for (let t = 0; t < e.ratings.length; t++) {
            ...
            for (let t = 0; t < n.length; t++) {
              const r = n[t];
              r.setAttribute("data-rating", i.rating), r.setAttribute("data-raters", i.raters)
            }
          }
      } else o = !1
    })
...
! function() {
  function e() {
    var t = document.querySelectorAll(".loox-widget-editor-callout");
    for (let e = 0; e < t.length; e++) {
      const l = t[e];
      var o = l.getAttribute("data-callout-widget-block");
      if (!l.querySelector("iframe") && o) {
        const n = document.createElement("iframe");
        n.src = `${LOOX.root}/widget/${LOOX.clientId}/callout?block=` + encodeURIComponent(o), n.style.border = "none", n.style.width = "100%", n.style.height = "auto", n.style.display = "block", l.innerHTML = "", l.appendChild(n)
      }
    }
  }
  setInterval(e, 500), e()
...
! function(i, n) {
  var t, e;
  n && !n.floating_widget && "undefined" != typeof loox_floating_widget && (n.floating_widget = loox_floating_widget, e = null, (t = function() {
    var t, o;
    if (e) return e;
    e = this, ("/" === (t = i.location.pathname) ? n.floating_widget.display_on_home_page : 0 === t.indexOf("/cart") ? n.floating_widget.display_on_cart_page : n.productId ? n.floating_widget.display_on_product_page : n.floating_widget.display_on_other_pages) && (o = this.createTogglerBtn(), n.domReady(() => n.floating_widget_timeout = setTimeout(() => {
      var t = document.querySelector(".loox-float-toggler-container-" + n.floating_widget.position);
      t && o && t.appendChild(o)
    }, 1500)))
  }).prototype.openHCFloater = function() {
    var t = i.location.pathname,
      o = null,
      e = document.getElementById("looxReviews"); - 1 !== t.indexOf("/products/") && e && e.dataset && void 0 === e.dataset.looxAggregate && (o = n.productId), n.openHCFloater(o)
  }, t.prototype.createTogglerBtn = function() {
    if (n.floating_widget.active && (!n.floating_widget.hide_on_mobile || !n.isMobile())) {
      var o = this,
        t = document.createElement("div"),
        e = n.createRatingIconSvg("full");
      t.appendChild(e);
      e = n.floating_widget.border_radius.value;
      return n.injectStyleTag(`
      ...
      #loox-floating-widget-btn { border-radius: 0 0 ${e} ${e} !important; }
      #loox-floating-widget-btn[data-orientation="flipped"] { border-radius: ${e} ${e} 0 0 !important;}
    `), t.innerHTML += " " + n.floating_widget.button_text, t.id = "loox-floating-widget-btn", t.classList.add("loox-float-toggler", "loox-floating-widget-btn"), t.setAttribute("tabindex", "0"), t.setAttribute("role", "button"), t.setAttribute("data-orientation", n.floating_widget.orientation), t.style.backgroundColor = "#" + (n.floating_widget.button_bg_color || "333"), t.style.color = "#" + (n.floating_widget.button_text_color || "fff"), t.addEventListener("keypress", function(t) {
        "Enter" !== t.code && "Space" !== t.code || o.openHCFloater()
      }), t.addEventListener("click", o.openHCFloater), t
    }
  }, t.prototype.overrideSettings = function(t) {
    n.floating_widget = t
  }, t.prototype.resetWidget = function() {
    n.floating_widget_timeout && clearTimeout(n.floating_widget_timeout);
    const t = document.querySelector("#loox-floating-widget-btn");
    var o = this.createTogglerBtn(),
      e = document.querySelector(".loox-float-toggler-container-" + n.floating_widget.position);
    o || ((o = document.createElement("div")).id = "loox-floating-widget-btn"), e ? t ? t.replaceWith(o) : e.appendChild(o) : (t && t.remove(), (e = document.querySelector(".loox-float-toggler-container")) && (e.classList.remove(...Array.from(e.classList)), e.classList.add("loox-float-toggler-container"), e.classList.add("loox-float-toggler-container-" + n.floating_widget.position), e.appendChild(o)))
  }, t.prototype.getClientSettingsFunc = function() {
    return n.getFloatingSettings
  }, i.LooxSidebar = new t)
}(window, LOOX || {});
LOOX.openVisitorLevelReferralModal = function() {
  ...
  function(r, o) {
    var e, i;
    o.domReady(o.initReferralEntryFormWidget), o && !o.visitor_level_referral && "undefined" != typeof visitor_level_referral && (o.visitor_level_referral = visitor_level_referral, i = null, (e = function() {
      var e, t;
      if (i) return i;
      i = this, e = r.location.pathname, !1 !== o.visitor_level_referral.sidebar_visible && ("/" === e ? o.visitor_level_referral.display_on_home_page : 0 === e.indexOf("/cart") ? o.visitor_level_referral.display_on_cart_page : o.productId ? o.visitor_level_referral.display_on_product_page : o.visitor_level_referral.display_on_other_pages) && (t = this.createTogglerBtn(), o.domReady(function() {
        o.visitor_level_referral_timeout = setTimeout(function() {
          var e = document.querySelector(".loox-float-toggler-container-" + o.visitor_level_referral.position);
          e && (0 === e.childNodes.length ? e.appendChild(t) : e.insertBefore(t, e.childNodes[0]))
        }, 1500)
      }))
    }).prototype.createTogglerBtn = function() {
      if (!o.visitor_level_referral.hide_on_mobile || !o.isMobile()) {
        var e = document.createElement("div");
        e.id = "loox-visitor-level-referral-btn", e.innerHTML = o.visitor_level_referral.button_text, e.classList.add("loox-float-toggler"), e.setAttribute("data-testid", "loox-referrals-modal-button"), e.setAttribute("tabindex", "0"), e.setAttribute("role", "button"), e.setAttribute("data-orientation", o.visitor_level_referral.orientation), e.style.backgroundColor = "#" + (o.visitor_level_referral.button_bg_color || "333"), e.style.color = "#" + (o.visitor_level_referral.button_text_color || "fff");
        var t = o.visitor_level_referral.border_radius.value;
        return o.injectStyleTag(`
      #loox-visitor-level-referral-btn { border-radius: 0 0 ${t} ${t} !important; }
      #loox-visitor-level-referral-btn[data-orientation="flipped"] { border-radius: ${t} ${t} 0 0 !important;}
    `), e.addEventListener("keypress", function(e) {
          "Enter" !== e.code && "Space" !== e.code || o.openVisitorLevelReferralModal()
        }), e.addEventListener("click", function() {
          o.openVisitorLevelReferralModal()
        }), e
      }
    }, e.prototype.overrideSettings = function(e) {
      o.visitor_level_referral = e
    }, e.prototype.resetWidget = function() {
      o.visitor_level_referral_timeout && clearTimeout(o.visitor_level_referral_timeout);
      const e = document.querySelector("#loox-visitor-level-referral-btn");
      var t = this.createTogglerBtn(),
        r = document.querySelector(".loox-float-toggler-container-" + o.visitor_level_referral.position);
      t || ((t = document.createElement("div")).id = "loox-visitor-level-referral-btn"), r ? e ? e.replaceWith(t) : 0 === r.childNodes.length ? r.appendChild(t) : r.insertBefore(t, r.childNodes[0]) : (e && e.remove(), (r = document.querySelector(".loox-float-toggler-container")) && (r.classList.remove(...Array.from(r.classList)), r.classList.add("loox-float-toggler-container"), r.classList.add("loox-float-toggler-container-" + o.visitor_level_referral.position), 0 === r.childNodes.length ? r.appendChild(t) : r.insertBefore(t, r.childNodes[0])))
    }, e.prototype.getClientSettingsFunc = function() {
      return o.getReferralsFloatingSettings
    }, r.LooxVisitorLevelReferral = new e)
  }(window, LOOX || {});
...
`;
  ...
  window.LOOX && !window.LOOX.renderTrustBadgeWidget && (window.LOOX.renderTrustBadgeWidget = () => {
    ...
    }), i && (a || (null == (r = (t = window.LOOX).injectStyleTag) || r.call(t, e), a = !0), (t => {
      var r = null == window ? void 0 : window.LOOX;
      if (r && r.root && r.clientId && r.hash) {
        let o = `${r.root}/widget/${r.clientId}/trust-badge?h=` + r.hash;
        t && (o += "&preview=true"), fetch(o)
      }
    })(!d))
...
! function() {
  function t(t, e) {
    const i = window.LOOX;
    if (!i.snippetsScriptLoaded) {
      const s = document.querySelector("loox-snippets-widget");
      if (s) {
        e && e.disconnect(), i.snippetsScriptLoaded = !0;
        const r = document.createElement("script");
        r.type = "text/javascript", r.async = !0;
        const n = new URL(`widget/${i.clientId}/snippets/snippets-widget.js?h=` + i.hash, i.root);
        i.multilingual && n.searchParams.set("language", i.shopifyLocale), s.getAttribute("data-preview") && n.searchParams.set("shopify_editor_preview", "true"), s.getAttribute("reviews-type") && n.searchParams.set("reviewsType", s.getAttribute("reviews-type")), s.getAttribute("product-id") && n.searchParams.set("productId", s.getAttribute("product-id")), s.getAttribute("reviews-limit") && n.searchParams.set("limit", s.getAttribute("reviews-limit")), r.src = n.toString();
...
! function() {
  function t(t, e) {
    if (!LOOX.reviewsStoriesEntryWidgetScriptLoaded) {
      const r = document.querySelector("loox-reviews-stories-entry-widget");
      if (r) {
        e && e.disconnect(), LOOX.reviewsStoriesEntryWidgetScriptLoaded = !0;
        const s = document.createElement("script");
        s.type = "text/javascript", s.async = !0;
        const i = new URL(`widget/${LOOX.clientId}/reviews-stories-entry-widget/reviews-stories-entry-widget.js?h=` + LOOX.hash, LOOX.root);
        LOOX.multilingual && i.searchParams.set("locale", LOOX.shopifyLocale), r.getAttribute("data-preview") && i.searchParams.set("shopify_editor_preview", "true"), r.getAttribute("product-id") && i.searchParams.set("productId", r.getAttribute("product-id")), r.getAttribute("tags") && i.searchParams.set("tags", r.getAttribute("tags")), r.getAttribute("review-count") && i.searchParams.set("reviewCount", r.getAttribute("review-count"));
        e = LOOX.experimentsAssignments?.reviews_stories_entry_widget_layouts?.variant, e = r.getAttribute("variant") || e;
        e && i.searchParams.set("variant", e), s.src = i.toString();
...
! function() {
  function e(e, t) {
    if (!LOOX.dynamicCarouselScriptLoaded) {
      const c = document.querySelector("loox-dynamic-carousel-widget");
      if (c) {
        t && t.disconnect(), LOOX.dynamicCarouselScriptLoaded = !0;
        const r = document.createElement("script");
        r.type = "text/javascript", r.async = !0;
        const o = new URL(`widget/${LOOX.clientId}/dynamic-carousel/dynamic-carousel.js?h=` + LOOX.hash, LOOX.root);
        LOOX.multilingual && o.searchParams.set("locale", LOOX.shopifyLocale), c.getAttribute("data-preview") && o.searchParams.set("shopify_editor_preview", "true"), c.getAttribute("product-id") && o.searchParams.set("productId", c.getAttribute("product-id")), r.src = o.toString();
        const a = document.getElementsByTagName("script")[0];
...
LOOX.reviewsStories = LOOX.reviewsStories || {
  loaded: !1,
  widgetElement: null,
  init: function(e) {
    if (!LOOX.reviewsStories.loaded) {
      const t = new URL(`widget/${LOOX.clientId}/reviews-stories-widget/reviews-stories-widget.js?storyId=${encodeURIComponent(e)}&h=` + LOOX.hash, LOOX.root);
      LOOX.multilingual && LOOX.shopifyLocale && t.searchParams.set("locale", LOOX.shopifyLocale), void 0 !== LOOX.shopify_editor_preview && LOOX.shopify_editor_preview && t.searchParams.set("shopify_editor_preview", "true");
      const i = document.createElement("script");
      i.type = "text/javascript", i.async = !0, i.src = t.toString();
      const o = document.getElementsByTagName("script")[0];
      o.parentNode.insertBefore(i, o)
    }
  },
  show: function(e, t, i) {
    const o = document.querySelector("loox-reviews-stories-widget");
    o && (o.remove(), LOOX.reviewsStories.widgetElement = null);
    const s = document.createElement("loox-reviews-stories-widget");
    s.className = "loox-floating-widget", e && s.setAttribute("product-id", e), t && s.setAttribute("product-img-url", t), i && s.setAttribute("product-title", i), document.body.appendChild(s), LOOX.reviewsStories.widgetElement = s
  }
}, LOOX.domReady(function() {});
! function() {
  var e;
...
\r"'\`<>=]|("|')|))|$)`, "g"),
  ...
  function nt(r) {
    return (t, e) => ("object" == typeof e ? (r = it, o, t) => {
      ...
      return e.constructor.createProperty(r, o ? {
        ...t,
        wrapped: !0
        ...
        if (i) {
          if (i.startsWith("LXZ")) {
            ...
            if (!r) {
              ...
              null != s && s.content && (t.content = s.content), sessionStorage.setItem("lx_discount_reminder", JSON.stringify({
                ...t
              }))
            }
            if (s && s.content && !(0 < document.getElementsByTagName($t).length)) {
              ...
              n.setAttribute("content", s.content), n.setAttribute("pixel-url", s.pixelURL), document.body.appendChild(n), n.show(), n.addEventListener("dismissed", () => {
                var t = At();
                sessionStorage.setItem("lx_discount_reminder", JSON.stringify({
                  ...t,
                  dismissed: !0
                }))
              })

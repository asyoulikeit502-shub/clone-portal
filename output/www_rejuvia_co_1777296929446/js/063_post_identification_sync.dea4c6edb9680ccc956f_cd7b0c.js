(self.webpackChunk_klaviyo_onsite_modules = self.webpackChunk_klaviyo_onsite_modules || []).push([
  [7327], {
    ...
    61595: function(e, t, n) {
      "use strict";
      var r = n(15957);
      const a = "kl-post-identification-sync",
        s = JSON.stringify([]),
        i = () => {
          try {
        ...
        l = (e = 1e3) => (async e => {
          ...
          const n = JSON.parse(t.getItem(a) || s),
            r = n.slice(0, e),
            o = n.slice(e);
          return {
            events: r || [],
            deleteCallback: async () => {
              t.setItem(a, JSON.stringify(o))
            }
          }
        })(e),
        u = () => (() => {
        ...
        p = (e, t) => {
          ...
          const r = (new Date).toISOString(),
            a = {
              name: e.event,
              time: (null == (n = e.properties) ? void 0 : n.time) || r,
      ...
      const w = (e, t, n, r, a) => {
                ...
                events: {
                  data: e.map((e => {
                    const {
                      name: t,
                      properties: r
                    } = e, a = f()(e, g), s = Object.assign({}, r, n || {}), i = s.service;
                    delete s.service;
                    const o = "klaviyo" === i ? {
                      name: t,
                      service: i
        ...
        O = e => {
          ...
          return Object.keys(_).forEach((n => {
            if (r = n, !Set.prototype.has.call(b, r)) return;
            var r;
            const a = e[n];
            if (!a) return;
            const s = ("$email" === n || "email" === n) && !(0, y.v)(a),
              i = "$phone_number" === n && !(0, v.y)(a);
        ...
        S = async (e, t, n, r, a) => {
          ...
          const s = await w(e.events, t, n, r, a);
      ...
      (() => {
        (0, r.e)("cacheEvent", p), (0, r.e)("sendCachedEvents", $)
      })()
    },
    5645: function(e) {

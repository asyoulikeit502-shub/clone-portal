  ...
  ["okendo-reviews-translation"], {
    a925: function(t, e, n) {
      ...
      function g() {
        ...
        var n = null,
          r = null;
        return 1 === t.length ? l(t[0]) || s(t[0]) ? r = t[0] : "string" === typeof t[0] && (n = t[0]) : 2 === t.length && ("string" === typeof t[0] && (n = t[0]), (l(t[1]) || s(t[1])) && (r = t[1])), {
          locale: n,
          params: r
        }
      }
      ...
      function F(t) {
        for (var e = arguments, n = Object(t), r = 1; r < arguments.length; r++) {
          ...
          if (void 0 !== a && null !== a) {
            var i = void 0;
            for (i in a) k(a, i) && (l(a[i]) ? n[i] = F(n[i], a[i]) : n[i] = a[i])
          }
        }
        return n
      }
        ...
        return void 0 === t && (t = !1), t ? {
          ...
          beforeCreate: function() {
            ...
            if (t.i18n = t.i18n || (t.__i18nBridge || t.__i18n ? {} : null), t.i18n)
              ...
              var o = t.i18n,
                s = o.sharedMessages;
              s && p(s) && (t.i18n.messages = F(t.i18n.messages, s)), this._i18n = new Tt(t.i18n), this._i18nWatcher = this._i18n.watchI18nData(), (void 0 === t.i18n.sync || t.i18n.sync) && (this._localeWatcher = this.$i18n.watchLocale()), r && r.onComponentInstanceCreated(this._i18n)
            } else 0;
          ...
          beforeMount: function() {
            var t = this.$options;
            t.i18n = t.i18n || (t.__i18nBridge || t.__i18n ? {} : null), t.i18n ? (t.i18n instanceof Tt || p(t.i18n)) && (this._i18n.subscribeDataChanging(this), this._subscribing = !0) : (this.$root && this.$root.$i18n && this.$root.$i18n instanceof Tt || t.parent && t.parent.$i18n && t.parent.$i18n instanceof Tt) && (this._i18n.subscribeDataChanging(this), this._subscribing = !0)
          },
          mounted: e,
        ...
        render: function(t, e) {
          ...
          if (o) {
            var s = a.path,
              ...
              c = a.places,
              u = i(),
              h = o.i(s, l, L(u) || c ? O(u.default, c) : u),
      ...
      function O(t, e) {
        ...
        var r = t.every(j);
        return t.reduce(r ? W : N, n)
      }

      function x(t) {
        return Array.isArray(t) ? t.reduce(N, {}) : Object.assign({}, t)
      }
      ...
      var S, E = {
        ...
        render: function(t, e) {
          ...
          var s = null,
            c = null;
          u(n.format) ? s = n.format : l(n.format) && (n.format.key && (s = n.format.key), c = Object.keys(n.format).reduce((function(t, e) {
            var a;
            return y(r, e) ? Object.assign({}, t, (a = {}, a[e] = n.format[e], a)) : t
          }), null));
          var h = n.locale || o.locale,
            f = o._ntp(n.value, h, s, c),
      ...
      function H(t, e, n, r) {
        if (P(t, n)) {
          ...
          A(t, n) && $(e.value, e.oldValue) && $(t._localeMessage, a.getLocaleMessage(a.locale)) || B(t, e, n)
        }
      }
      ...
      function B(t, e, n) {
        ...
        if (l || c || u)
          if (l) {
            var f = n.context;
            t._vt = t.textContent = null != h ? (r = f.$i18n).tc.apply(r, [l, h].concat(z(c, u))) : (a = f.$i18n).t.apply(a, [l].concat(z(c, u))), t._locale = f.$i18n.locale, t._localeMessage = f.$i18n.getLocaleMessage(f.$i18n.locale)
      ...
      function U(t) {
        var e, n, r, a;
        return u(t) ? e = t : p(t) && (e = t.path, n = t.locale, r = t.args, a = t.choice), {
          path: e,
          locale: n,
          args: r,
          choice: a
      ...
      function J(t, e) {
        ...
        S.version && Number(S.version.split(".")[0]);
        C(S), S.mixin(I(e.bridge)), S.directive("t", {
          bind: R,
          update: H,
          unbind: V
        }), S.component(D.name, D), S.component(E.name, E);
        var n = S.config.optionMergeStrategies;
        n.i18n = function(t, e) {
          return void 0 === e ? t : e
        }
      }
      ...
      G.prototype.interpolate = function(t, e) {
        ...
        return n || (n = Y(t), this._caches[t] = n), X(n, e)
      };
      var q = /^(?:\d)+/,
        Z = /^(?:\w)+/;
      ...
      function Y(t) {
        ...
        while (n < t.length) {
          ...
          if ("{" === a) {
            ...
            var o = "}" === a,
              s = q.test(i) ? "list" : o && Z.test(i) ? "named" : "unknown";
            e.push({
              value: i,
              type: s
            })
      ...
      function X(t, e) {
        var n = [],
          r = 0,
          a = Array.isArray(e) ? "list" : l(e) ? "named" : "unknown";
      ...
      function gt(t) {
        var e = t.trim();
        return ("0" !== t.charAt(0) || !isNaN(t)) && (pt(e) ? _t(e) : "*" + e)
      }
      ...
      function vt(t) {
        ...
        function p() {
          var e = t[c + 1];
          if (u === st && "'" === e || u === lt && '"' === e) return c++, r = "\\" + e, f[K](), !0
        }
        f[Q] = function() {
          ...
          if (h > 0) h--, u = ot, f[K]();
            ...
            if (n = gt(n), !1 === n) return !1;
            f[Q]()
          }
        };
        while (null !== u)
          if (c++, e = t[c], "\\" !== e || !p()) {
            if (a = mt(e), s = ht[u], i = s[a] || s["else"] || ut, i === ut) return;
      ...
      var bt, yt = /<\/?[\w\s="/.':;#-\/]+>/,
        ...
        Tt = function(t) {
          var e = this;
          void 0 === t && (t = {}), !S && "undefined" !== typeof window && window.Vue && J(window.Vue);
          ...
          this._vm = null, this._formatter = t.formatter || Mt, this._modifiers = t.modifiers || {}, this._missing = t.missing || null, this._root = t.root || null, this._sync = void 0 === t.sync || !!t.sync, this._fallbackRoot = void 0 === t.fallbackRoot || !!t.fallbackRoot, this._fallbackRootWithEmptyString = void 0 === t.fallbackRootWithEmptyString || !!t.fallbackRootWithEmptyString, this._formatFallbackMessages = void 0 !== t.formatFallbackMessages && !!t.formatFallbackMessages, this._silentTranslationWarn = void 0 !== t.silentTranslationWarn && t.silentTranslationWarn, this._silentFallbackWarn = void 0 !== t.silentFallbackWarn && !!t.silentFallbackWarn, this._dateTimeFormatters = {}, this._numberFormatters = {}, this._path = new dt, this._dataListeners = new Set, this._componentInstanceCreatedListener = t.componentInstanceCreatedListener || null, this._preserveDirectiveContent = void 0 !== t.preserveDirectiveContent && !!t.preserveDirectiveContent, this.pluralizationRules = t.pluralizationRules || {}, this._warnHtmlInMessage = t.warnHtmlInMessage || "off", this._postTranslation = t.postTranslation || null, this._escapeParameterHtml = t.escapeParameterHtml || !1, "__VUE_I18N_BRIDGE__" in t && (this.__VUE_I18N_BRIDGE__ = t.__VUE_I18N_BRIDGE__), this.getChoiceIndex = function(t, n) {
            ...
            return !(!t || !n) && (!_(e._path.getPathValue(t, n)) || !!t[n])
      ...
      Tt.prototype._checkLocaleMessage = function(t, e, n) {
        var r = [],
          a = function(t, e, n, r) {
            if (p(n)) Object.keys(n).forEach((function(i) {
              var o = n[i];
              p(o) ? (r.push(i), r.push("."), a(t, e, o, r), r.pop(), r.pop()) : (r.push(i), a(t, e, o, r), r.pop())
            }));
            else if (s(n)) n.forEach((function(n, i) {
              p(n) ? (r.push("[" + i + "]"), r.push("."), a(t, e, n, r), r.pop(), r.pop()) : (r.push("[" + i + "]"), a(t, e, n, r), r.pop())
            }));
            else if (u(n)) {
              var l = yt.test(n);
              if (l) {
      ...
      }, Tt.prototype._warnDefault = function(t, e, n, r, a, i) {
        if (!_(n)) return n;
        if (this._missing) {
        ...
        if (this._formatFallbackMessages) {
          var s = g.apply(void 0, a);
          return this._render(e, i, s.params, e)
        }
        return e
      }, Tt.prototype._isFallbackRoot = function(t) {
        return (this._fallbackRootWithEmptyString ? !t : _(t)) && !_(this._root) && this._fallbackRoot
      ...
      }, Tt.prototype._interpolate = function(t, e, n, r, a, i, o) {
        if (!e) return null;
        var l, c = this._path.getPathValue(e, n);
        if (s(c) || p(c)) return c;
        if (_(c)) {
          if (!p(e)) return null;
          if (l = e[n], !u(l) && !m(l)) return null
        } else {
          if (!u(c) && !m(c)) return null;
          l = c
        }
        return u(l) && (l.indexOf("@:") >= 0 || l.indexOf("@.") >= 0) && (l = this._link(t, e, l, r, "raw", i, o)), this._render(l, a, i, n)
      }, Tt.prototype._link = function(t, e, n, r, a, i, o) {
        var l = n,
          c = l.match(wt);
        for (var u in c)
          if (c.hasOwnProperty(u)) {
            var h = c[u],
              ...
              p = f[0],
              _ = f[1],
              m = h.replace(p, "").replace(Ft, "");
            if (y(o, m)) return l;
            o.push(m);
            var g = this._interpolate(t, e, m, r, "raw" === a ? "string" : a, "raw" === a ? void 0 : i, o);
            if (this._isFallbackRoot(g)) {
              if (!this._root) throw Error("unexpected error");
              var v = this._root.$i18n;
              g = v._translate(v._getMessages(), v.locale, v.fallbackLocale, m, r, a, i)
            }
            g = this._warnDefault(t, m, g, r, s(i) ? i : [i], a), this._modifiers.hasOwnProperty(_) ? g = this._modifiers[_](g) : $t.hasOwnProperty(_) && (g = $t[_](g)), o.pop(), l = g ? l.replace(h, g) : l
          } return l
        ...
        if (m(t)) return t(this._createMessageContext(n, this._formatter || Mt, r, e));
        var a = this._formatter.interpolate(t, n, r);
        return a || (a = Mt.interpolate(t, n, r)), "string" !== e || u(a) ? a : a.join("")
        ...
        for (var r = !0, a = 0; a < e.length && c(r); a++) {
          var i = e[a];
        ...
        if (!n) {
          ...
          var r, a = [t];
          while (s(a)) a = this._appendBlockToChain(n, a, e);
          r = s(e) ? e : l(e) ? e["default"] ? e["default"] : null : e, a = u(r) ? [r] : r, a && this._appendBlockToChain(n, a, null), this._localeChainCache[t] = n
        }
        return n
      }, Tt.prototype._translate = function(t, e, n, r, a, i, o) {
        for (var s, l = this._getLocaleChain(e, n), c = 0; c < l.length; c++) {
          var u = l[c];
          if (s = this._interpolate(u, t[u], r, a, i, o, [r]), !_(s)) return s
        }
        return null
      ...
      }, Tt.prototype._i = function(t, e, n, r, a) {
      ...
      }, Tt.prototype._tc = function(t, e, n, r, a) {
        var i, o = [],
        ...
        var i = g.apply(void 0, r).locale || e;
        ...
        "warn" !== this._warnHtmlInMessage && "error" !== this._warnHtmlInMessage || this._checkLocaleMessage(t, this._warnHtmlInMessage, e), this._vm.$set(this._vm.messages, t, F("undefined" !== typeof this._vm.messages[t] && Object.keys(this._vm.messages[t]).length ? Object.assign({}, this._vm.messages[t]) : {}, e))
        ...
        this._vm.$set(this._vm.dateTimeFormats, t, F(this._vm.dateTimeFormats[t] || {}, e)), this._clearDateTimeFormat(t, e)
      }, Tt.prototype._clearDateTimeFormat = function(t, e) {
        for (var n in e) {
          var r = t + "__" + n;
          this._dateTimeFormatters.hasOwnProperty(r) && delete this._dateTimeFormatters[r]
        }
      }, Tt.prototype._localizeDateTime = function(t, e, n, r, a, i) {
        for (var o = e, s = r[o], l = this._getLocaleChain(e, n), c = 0; c < l.length; c++) {
          var u = l[c];
          if (s = r[u], o = u, !_(s) && !_(s[a])) break
        }
        if (_(s) || _(s[a])) return null;
        var h, f = s[a];
        if (i) h = new Intl.DateTimeFormat(o, Object.assign({}, f, i));
        else {
          var p = o + "__" + a;
          h = this._dateTimeFormatters[p], h || (h = this._dateTimeFormatters[p] = new Intl.DateTimeFormat(o, f))
        }
        return h.format(t)
      }, Tt.prototype._d = function(t, e, n, r) {
        if (!n) {
          var a = r ? new Intl.DateTimeFormat(e, r) : new Intl.DateTimeFormat(e);
          return a.format(t)
        }
        ...
        var r = this.locale,
          i = null,
          o = null;
        return 1 === e.length ? (u(e[0]) ? i = e[0] : l(e[0]) && (e[0].locale && (r = e[0].locale), e[0].key && (i = e[0].key)), o = Object.keys(e[0]).reduce((function(t, n) {
          var r;
          return y(a, n) ? Object.assign({}, t, (r = {}, r[n] = e[0][n], r)) : t
        }), null)) : 2 === e.length && (u(e[0]) && (i = e[0]), u(e[1]) && (r = e[1])), this._d(t, r, i, o)
        ...
        this._vm.$set(this._vm.numberFormats, t, F(this._vm.numberFormats[t] || {}, e)), this._clearNumberFormat(t, e)
      }, Tt.prototype._clearNumberFormat = function(t, e) {
        for (var n in e) {
          var r = t + "__" + n;
          this._numberFormatters.hasOwnProperty(r) && delete this._numberFormatters[r]
        }
      }, Tt.prototype._getNumberFormatter = function(t, e, n, r, a, i) {
        for (var o = e, s = r[o], l = this._getLocaleChain(e, n), c = 0; c < l.length; c++) {
          var u = l[c];
          if (s = r[u], o = u, !_(s) && !_(s[a])) break
        }
        ...
        if (i) h = new Intl.NumberFormat(o, Object.assign({}, f, i));
          ...
          var p = o + "__" + a;
          h = this._numberFormatters[p], h || (h = this._numberFormatters[p] = new Intl.NumberFormat(o, f))
        }
        return h
        ...
        var a = this.locale,
          i = null,
          o = null;
        return 1 === e.length ? u(e[0]) ? i = e[0] : l(e[0]) && (e[0].locale && (a = e[0].locale), e[0].key && (i = e[0].key), o = Object.keys(e[0]).reduce((function(t, n) {
          var a;
          return y(r, n) ? Object.assign({}, t, (a = {}, a[n] = e[0][n], a)) : t
        }), null)) : 2 === e.length && (u(e[0]) && (i = e[0]), u(e[1]) && (a = e[1])), this._n(t, a, i, o)
        ...
        return o || []
      }, Object.defineProperties(Tt.prototype, Ct), Object.defineProperty(Tt, "availabilities", {
        get: function() {
          if (!bt) {
      ...
      }), Tt.install = J, Tt.version = "8.28.2", e["a"] = Tt
    }
  }
]);